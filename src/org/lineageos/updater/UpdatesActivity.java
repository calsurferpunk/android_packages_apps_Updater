...
public class UpdatesActivity extends UpdatesListActivity {
    ...
    private void showPreferencesDialog() {
        ...
        SwitchCompat useUnofficialSource = view.findViewById(R.id.preferences_use_unofficial_source);
        ...
        useUnofficialSource.setChecked(prefs.getBoolean(Constants.PREF_USE_UNOFFICIAL_SOURCE, true));
        ...
        new AlertDialog.Builder(this)
                ...
                .setOnDismissListener(dialogInterface -> {
                    prefs.edit()
                            ...
                            .putBoolean(Constants.PREF_USE_UNOFFICIAL_SOURCE, useUnofficialSource.isChecked())
                            .apply();
